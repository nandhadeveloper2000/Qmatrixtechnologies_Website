  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#020617]">
      ...
      <div className="absolute inset-0 opacity-80">
        <div className="bg-shift absolute left-[-8rem] top-[-8rem] h-[28rem] w-[28rem] rounded-full bg-fuchsia-500/20 blur-3xl" />
        <div className="bg-shift absolute right-[-8rem] top-[8%] h-[24rem] w-[24rem] rounded-full bg-violet-500/20 blur-3xl [animation-delay:2s]" />
        <div className="bg-shift absolute bottom-[-10rem] left-[12%] h-[30rem] w-[30rem] rounded-full bg-sky-500/20 blur-3xl [animation-delay:4s]" />
        <div className="bg-shift absolute bottom-[5%] right-[10%] h-[18rem] w-[18rem] rounded-full bg-purple-400/15 blur-3xl [animation-delay:1.5s]" />
      </div>
      ...
      <div className="absolute inset-0 opacity-[0.11] [background-image:linear-gradient(rgba(255,255,255,0.10)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:62px_62px]" />
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-8 sm:px-6 lg:px-10">
        <div className="relative w-full max-w-lg">
          ...
          <div className="tilt-glow absolute inset-[-1px] rounded-[36px] bg-[linear-gradient(135deg,rgba(255,255,255,0.22),rgba(255,255,255,0.06),rgba(255,255,255,0.14))] opacity-70 blur-sm" />

          <div className="relative overflow-hidden rounded-[36px] border border-white/15 bg-white/[0.08] p-6 shadow-[0_24px_120px_rgba(0,0,0,0.50)] backdrop-blur-2xl sm:p-8">
                ...
                <div>
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      className="h-14 w-full rounded-2xl border border-white/15 bg-white/[0.08] pl-12 pr-4 text-sm text-white outline-none transition placeholder:text-white/35 focus:border-fuchsia-400/70 focus:bg-white/[0.11] focus:ring-4 focus:ring-fuchsia-400/15 disabled:cursor-not-allowed disabled:opacity-70"
                    />
                  </div>
                </div>
                    ...
                    <div className="flex items-center justify-between gap-2 sm:gap-3">
                      {otpValues.map((digit, index) => (
                        <input
                          ...
                          className="h-14 w-12 rounded-2xl border border-white/15 bg-white/[0.08] text-center text-xl font-bold tracking-wider text-white outline-none transition focus:border-fuchsia-400/70 focus:bg-white/[0.14] focus:ring-4 focus:ring-fuchsia-400/15 sm:h-16 sm:w-14"
                        />
                      ))}
                    </div>
