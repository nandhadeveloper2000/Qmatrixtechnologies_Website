...
export default function EditUserClient({ id }: { id: string }) {
  ...
  const loadUser = useCallback(async () => {
    ...
    try {
      ...
      const endpoint = SummaryApi.userById(id);

      const res = await apiFetch<GetUserRes>(endpoint.url, {
  ...
  async function handleUpdate() {
    ...
    try {
      ...
      const endpoint = SummaryApi.updateUser(id);

      const res = await apiFetch<UpdateUserRes>(endpoint.url, {
        method: endpoint.method,
        json: payload,
      });
  ...
  async function handleDeleteAvatar() {
    ...
    try {
      ...
      const endpoint = SummaryApi.deleteUserAvatar(id);
