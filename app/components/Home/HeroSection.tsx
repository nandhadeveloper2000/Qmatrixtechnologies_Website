        ...
        <div className="grid min-h-[560px] items-center gap-10 py-14 lg:grid-cols-2 lg:gap-12 lg:py-16">
          ...
          >
            ...
            <h1 className="mt-6 text-[42px] font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-[54px]">
              ...
              with{" "}
              <span className="bg-gradient-to-r from-secondary to-[#7C3AED] bg-clip-text text-transparent">
                Premier Cloud &amp; Data
              </span>
              <br />
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              <button className="group relative inline-flex items-center justify-center rounded-full bg-gradient-to-r from-secondary to-[#7C3AED] px-7 py-3 text-sm font-semibold text-white shadow-[0_18px_45px_rgba(124,58,237,0.25)] transition hover:scale-[1.03] active:scale-[0.99]">
                ENROLL NOW
          ...
          >
            ...
            {/* glow behind image */}
            <div className="pointer-events-none absolute -z-10 right-4 top-1/2 h-[420px] w-[420px] -translate-y-1/2 rounded-full bg-gradient-to-tr from-primary/15 via-secondary/10 to-[#7C3AED]/10 blur-3xl lg:right-0" />
