...
export default function InstagramFeed() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f8f7ff] to-white py-24">
      {/* Background Glow */}
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900">
            Our Instagram{" "}
            <span className="bg-gradient-to-r from-[#8b1ccf] to-[#6d28d9] bg-clip-text text-transparent">
              Feed
            </span>{" "}
            ...
            {[...instagramPosts, ...instagramPosts].map((post, i) => (
              ...
              >
                <div className="relative rounded-3xl bg-white/70 p-4 backdrop-blur-xl shadow-[0_25px_60px_rgba(15,23,42,0.12)] ring-1 ring-slate-200/60 transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_35px_80px_rgba(15,23,42,0.18)]">
                  ...
                  {/* Hover Glow */}
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-[#8b1ccf]/20 to-[#6d28d9]/20 opacity-0 blur-xl transition group-hover:opacity-100" />
                  ...
                  {/* Bottom overlay */}
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 rounded-b-3xl bg-gradient-to-t from-black/20 to-transparent opacity-60" />
                </div>
              </a>
            ))}
          </div>
        ...
        <div className="mt-10 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-[#8b1ccf] to-[#6d28d9] px-8 py-4 text-sm font-semibold text-white shadow-[0_15px_40px_rgba(139,28,207,0.35)] transition-all duration-300 hover:scale-105"
          >
