    ...
    <section className="relative w-full overflow-hidden bg-white py-10">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative mt-8 overflow-hidden">
          ...
          <div className="pointer-events-none absolute left-0 top-0 h-full w-24 bg-linear-to-r from-white to-transparent" />
          <div className="pointer-events-none absolute right-0 top-0 h-full w-24 bg-linear-to-l from-white to-transparent" />
        </div>
      </div>
    </section>
  );
