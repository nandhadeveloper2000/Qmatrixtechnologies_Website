      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/80 md:text-lg">
            Upgrade your skills with industry-oriented courses designed for
            real-world careers. Learn from experts, build projects, and
            accelerate your IT career growth.
          </p>
