...
export default function CourseFormProgress({
  items,
  activeSection,
}: Props) {
  ...
  return (
    <aside className="sticky top-24">
      <div className="rounded-[28px] border border-slate-200 bg-white/95 p-5 shadow-lg backdrop-blur">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Jump between sections and track completion.
          </p>
        </div>
