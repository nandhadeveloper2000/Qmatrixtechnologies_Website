...
export default function Navbar() {
  ...
  // ✅ Close mobile drawer + dropdown when route changes
  useEffect(() => {
    setIsOpen(false);
    setMoreOpen(false);
  }, [pathname]);
    ...
    <>
      ...
      >
        ...
        >
          <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
            <div className="flex h-[78px] items-center gap-4 sm:h-[86px]">
              {/* LEFT: Logo */}
              <Link href="/" className="flex shrink-0 items-center">
                <Image
                  ...
                  height={70}
                  priority
                  className="h-auto w-[200px] sm:w-[200px] md:w-[200px] lg:w-[350px] lg:-ml-10 object-contain"
                />
              </Link>

              {/* CENTER: Desktop Nav */}
              <div className="hidden flex-1 items-center justify-center min-w-0 lg:flex">
                        ...
                        return (
                          <li key={item.name} className="relative" ref={moreRef}>
                            ...
                            >
                              ...
                              />
                              {anyChildActive && (
                                <span className="absolute left-0 -bottom-[2px] h-[3px] w-[28px] rounded-full bg-[var(--tg-theme-primary)]" />
                              )}
                            </button>
              ...
              <div className="hidden shrink-0 items-center lg:flex lg:-mr-10">
                {variant === "qmatrix" ? (
                  ...
                  <div className="flex items-center gap-3">
                    <Link href="/enquiry" className="btn btn-shine">
                      ENQUIRE NOW
                    </Link>
              ...
              <button
                ...
                className="ml-auto lg:hidden rounded-xl p-2.5 hover:bg-white/60 active:scale-[0.98] transition"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-black/5 px-5 py-4">
          ...
          width={200}
          height={60}
          className="h-auto w-[150px] sm:w-[170px] object-contain"
          />
          <button
            onClick={() => setIsOpen(false)}
        ...
        <div className="flex h-[calc(100%-72px)] flex-col">
          ...
          {/* ✅ FOOTER (CTA + Social) */}
          <div className="mt-auto border-t border-black/5 bg-gradient-to-b from-white to-slate-50 px-7 py-2">
            {/* CTA Buttons */}
