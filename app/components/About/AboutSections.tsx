...
export default function AboutSections() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-16 md:py-20">
      ...
      <motion.div
        aria-hidden="true"
        className="pointer-events-none absolute -left-40 top-[-120px] h-[320px] w-[320px] rounded-full bg-[rgba(167,36,228,0.14)] blur-3xl"
        animate={{ y: [0, 18, 0], scale: [1, 1.06, 1] }}
        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        aria-hidden="true"
        className="pointer-events-none absolute -right-40 bottom-[-140px] h-[360px] w-[360px] rounded-full bg-[rgba(8,42,94,0.10)] blur-3xl"
