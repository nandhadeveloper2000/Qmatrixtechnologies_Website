...
export default function VisionMissionLikeTemplate() {
    return (
        <section className="relative overflow-hidden bg-white py-14 sm:py-16 lg:py-20">
            {/* soft glow */}
            <div className="pointer-events-none absolute -left-24 -top-24 h-80 w-[320px] sm:h-95 sm:w-95 rounded-full bg-[rgba(145,22,161,0.10)] blur-3xl" />
            <div className="pointer-events-none absolute -right-28 -bottom-35 h-90 w-90 sm:h-105 sm:w-105 rounded-full bg-[rgba(8,42,94,0.08)] blur-3xl" />
            ...
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
                <div className="relative overflow-hidden rounded-[22px] sm:rounded-[28px] border border-black/10 bg-white shadow-[0_30px_90px_rgba(0,0,0,0.10)] sm:shadow-[0_40px_110px_rgba(0,0,0,0.10)]">
                    ...
                    <div aria-hidden="true" className="absolute inset-0">
                        ...
                        {/* right “cap” */}
                        <div
                            className="absolute -right-10 -top-10 h-45 w-55 sm:h-55 sm:w-65 rounded-[44px] sm:rounded-[56px] bg-[rgba(8,42,94,0.06)]"
