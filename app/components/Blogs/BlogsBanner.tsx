  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      >
        ...
        {/* Side Glows */}
        <div className="pointer-events-none absolute -left-32 -top-30 h-75 w-75 rounded-full bg-white/20 blur-3xl" />
        <div className="pointer-events-none absolute -right-40 -top-37.5 h-87.5 w-87.5 rounded-full bg-purple-300/30 blur-3xl" />
...
Blogs          </h1>
          ...
          <div className="mx-auto mt-4 h-0.5 w-20 rounded-full bg-white/40" />
